...
class SearchProblem:
    """
    This class outlines the fringe of a search problem, but doesn't implement
    ...
    while not fringe.isEmpty():
        ...
        if node not in closed:
            ...
            for childNode in problem.getSuccessors(node):
                newPath = path + [childNode[1]]
                newNode = (childNode[0], newPath)
                fringe.push(newNode)
    return result
    ...
    while not fringe.isEmpty():
        ...
        if node not in closed:
            ...
            for childNode in problem.getSuccessors(node):
                ...
                newNode = (childNode[0], newPath, newCost)
